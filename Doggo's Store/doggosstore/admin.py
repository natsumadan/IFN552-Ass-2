...
@bp.route('/dbseed/')
def dbseed():
    product1 = Product(name='Sydney', image='sydney.jpg', \
...
spectacular beaches; beautiful parks; a wealth of diversity; incredibly tasty food; The Harbour; and outdoor experiences''')
    product2 = Product(name='Brisbane', image='brisbane.jpg', \
...
friendly Koalas; dolphin spotting; sand Dunes; being a cosmopolitan city; tremendous beaches within 45 minutes; diversity of eateries; and daily tours to Fraser Island and the Reef''')
    product3 = Product(name='Melbourne', image='melbourne.jpg', \
...
being the world’s most livable city; amazing coffee; being the sports capital of Australia; urban laneways; incredible food; eclectic festivals; and fashion-forward trends''')
    ...
    t1 = Item(product_id=product1.id, image='t_cuddle.jpg', price=59.99,\
    ...
    t2 = Item(product_id=product1.id, image='t_hand.jpg', price=100.50,\
    ...
    t3 = Item(product_id=product1.id, image='t_sand.jpg', price=180.50,\
    ...
    t4 = Item(product_id=product1.id, image='t_whale.jpg', price=99.99,\
    ...
    t5 = Item(product_id=product2.id, image='t_trek.jpg', price=49.00,\
    ...
    t6 = Item(product_id=product2.id, image='t_island.jpg', price=250.99,\
    ...
    t7 = Item(product_id=product2.id, image='t_freshwater.jpg', price=120.00,\
    ...
    t8 = Item(product_id=product2.id, image='t_cruise.jpg', price=60.00,\
    ...
    t9 = Item(product_id=product3.id, image='t_go.jpg', price=189.99,\
        date=datetime.datetime(2020, 5, 17),\
    ...
    t10 = Item(product_id=product3.id, image='t_climb.jpg', price=89.95,\
    ...
    t11 = Item(product_id=product3.id, image='t_ride.jpg', price=45.99,\
    ...
    t12 = Item(product_id=product3.id, image='t_sunrise.jpg', price=49.99,\
    ...
    t13 = Item(product_id=product3.id, image='t_streets.jpg', price=45.00,\
